...
const definitions: NodeDefinition[] = [
    ...
    { id: CanvasNodeType.Image, version: 1, title: "图片", connectionTitle: "图片生成", inputs: Object.freeze([]), outputs: Object.freeze([{ id: "media", provides: "image" as const }]), createMetadata: () => ({ content: "", status: "idle" }), render: BuiltinNodeRenderer, icon: <ImageIcon className={iconClass} />, defaultSize: Object.freeze({ width: 340, height: 240 }), minimapColor: "#5372b9", keepAspectRatio: (node) => !node.metadata?.freeResize, resource: builtinResource },
